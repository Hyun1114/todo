  ...
  <body class="light ">
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" id="addMemberForm" method="post" action="${pageContext.request.contextPath}/AddMember">
          ...
          <button class="btn btn-lg btn-primary btn-block" id="addMemberBtn" type="submit">회원가입</button>
          <br>
          <button class="btn btn-lg btn-primary" type="reset">초기화</button>
    ...
    <script>
		let addMemberBtn = $('#addMemberBtn').click(function() {
