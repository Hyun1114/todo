  ...
  <body class="light ">
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" id="removeForm" method="post" action="${pageContext.request.contextPath}/member/removeMember">
          ...
          <h1 class="h6 mb-3">회원탈퇴</h1>
          <h3>비밀번호를 입력해주세요!</h3>
          <div class="form-group">
            <label for="loginMemberId" class="sr-only">아이디</label>
            <input type="text" id="memberId" name="memberId" class="form-control form-control-lg" required="" autofocus="" readonly="readonly" value="${loginMember.getMemberId()}">
          </div>
          <div class="form-group">
          ...
          <button class="btn btn-lg btn-primary btn-block" id="removeBtn" type="submit">회원탈퇴</button>
          <br>
    ...
    <script>
		let removeBtn = $('#removeBtn').click(function() {
